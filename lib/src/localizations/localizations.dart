...
class LocalizationsModule extends CommonModule {
  LocalizationsModule({required super.remoteArguments});
  ...
  void init({required List<String> remoteArguments}) {
    <RemoteConfig>[
      ...
      yamlConfigName: 'flutter_code_localization_inspector',
...
/// Printer - LocalizationsModule Extension
extension PrinterLocalizationsModuleExtension on LocalizationsModule {
  void printHelp() {
    Printer()
      ..h1('Help')
